...
const _primaryDark = Color(0xFF4B44CC);
...
class _OtpScreenState extends State<OtpScreen> with SingleTickerProviderStateMixin {
  ...
  Timer? _timer;
  bool _nameRequired = false; // shown after first failed verify (new user)
  ...
  Future<void> _verify() async {
    ...
    if (!success && mounted) {
      ...
      // Show name field in case user is new and needs to provide name
  ...
  Widget build(BuildContext context) {
    ...
    final defaultTheme = PinTheme(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFDDD8FF), width: 1.5),
      ),
    );
                ...
                RichText(
                  ...
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: widget.phone, style: const TextStyle(fontWeight: FontWeight.w700, color: _primary)),
                    ],
                  ),
                ),
